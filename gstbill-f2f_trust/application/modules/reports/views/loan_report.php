<style>
    .kt-datatable__table tbody tr td:nth-child(3) span{text-align:center !important;}
    .kt-datatable__table tbody tr td:nth-child(5) span{text-align:center !important;}
    .kt-datatable__table tbody tr td:nth-child(4) span, .kt-datatable__table tbody tr td:nth-child(7) span{text-align:center !important;}
    .kt-datatable__table tbody tr td:nth-child(6) span{text-align:right !important;}
    .kt-checkbox {margin-bottom: 0rem; margin-right: 10px;}
            ...
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__group" id="kt_subheader_search">
                    <form class="" id="kt_subheader_search_form">
                        <div class="kt-input-icon kt-input-icon--right kt-subheader__search">
                            <input type="text" class="form-control" placeholder="From Year" id="from_course_complete_date" disabled>
                ...
                <div class="kt-subheader__group" id="kt_subheader_search">
                    <form class="kt-margin-l-5" id="kt_subheader_search_form">
                        <div class="kt-input-icon kt-input-icon--right kt-subheader__search">
                            <input type="text" class="form-control" placeholder="To Year" id="to_course_complete_date" disabled>
                            <span class="kt-input-icon__icon kt-input-icon__icon--right">
                                <span>
                                    <i class="flaticon2-calendar"></i>
                                </span>
...
<script>
                ...
                $http.get(base_url + 'users/getPermissions')
                        .success(function (response) {
                            ...
                            if (modules_permission['reports']) {
                                if (modules_permission['reports']['loan_report']) {
    ...
    var dataTable = function () {
        ...
        var demo = function () {
                ...
                data: {
                    ...
                    source: {
                        read: {
                            ...
                            url: base_url + 'reports/loan_report/getLoanReport',
                            map: function (raw) {
                                var indexNumber = 0;
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        template: function (row) {
                            //console.log(row);
                          //  return row.for_year;
                            var for_year_date = row.for_year;
                            var for_year = "-";
                            if (for_year_date != '0000-00-00' && for_year_date != null && for_year_date !='1970-01-01') {
                                var for_year_dateSplit = for_year_date.split("-");
                                var for_year = for_year_dateSplit[2] + "/" + for_year_dateSplit[1] + "/" + for_year_dateSplit[0];
                            }
                    ...
                    },
                    {
                        ...
                        template: function (row) {
                            ...
                            var receipt_date = "-";
                            if (receipt_dateGet != '0000-00-00' && receipt_dateGet != "" && receipt_dateGet!= null) {
                                var receipt_dateGetSplit = receipt_dateGet.split("-");
                                var receipt_date = receipt_dateGetSplit[2] + "/" + receipt_dateGetSplit[1] + "/" + receipt_dateGetSplit[0];
                            }
            ...
            $('#search').on('click', function () {
                ...
                var fromCourseCompleteDate = "";
                var toCourseCompleteDate = "";
                var fromDate = form_date;
                if (form_date) {
                    //fromDate = convertDate(form_date);
                }
                ...
                var from_course_complete_date = $("#from_course_complete_date").val();
                if (from_course_complete_date) {
                    //fromCourseCompleteDate = convertDate(from_course_complete_date);
                }

                var to_course_complete_date = $("#to_course_complete_date").val();
                if (to_course_complete_date) {
                    //toCourseCompleteDate = convertDate(to_course_complete_date);
                }
                ...
                var value = {
                    ...
                    fromCourseCompleteDate: from_course_complete_date,
                    toCourseCompleteDate: to_course_complete_date
                }
                datatable.setDataSourceParam('query', value);
                datatable.load();
            });
            ...
            $(document).on('change', 'input[name=all]', function () {
                if (this.checked) {
                    ...
                    $("#from_date").val("");
                    $("#to_date").val("");
                    $("#from_course_complete_date").prop("disabled", true);
                    $("#to_course_complete_date").prop("disabled", true);
                    $("#from_course_complete_date").val("");
                    $("#to_course_complete_date").val("");
                    var value = {
                        all: true,
                    }
                    datatable.setDataSourceParam('query', value);
                    ...
                    $("#from_course_complete_date").prop("disabled", false);
                    $("#to_course_complete_date").prop("disabled", false);
                }
            });
        };
        return {
    ...
    var KTFormWidgets = function () {
        ...
        var initWidgets = function () {
            ...
            $('#from_course_complete_date').datepicker({
                todayHighlight: true,
                viewMode: "years",
                minViewMode: "years",
                format:'yyyy',
            ...
            $('#to_course_complete_date').datepicker({
                todayHighlight: true,
                viewMode: "years",
                minViewMode: "years",
                format:'yyyy',
...
<script>
    ...
    jq(document).on('click', '#entire_data_export,#download_pdf', function () {
        ...
        arr.push({'all': all});
        arr.push({'fromCourseCompleteDate': from_course_complete_date});
        arr.push({'toCourseCompleteDate': to_course_complete_date});
        arr.push({'type': type});
        var arrStr = JSON.stringify(arr);

        window.location.replace(base_url + 'reports/loan_report/get_export_loan_report?search=' + arrStr);
    });
</script>