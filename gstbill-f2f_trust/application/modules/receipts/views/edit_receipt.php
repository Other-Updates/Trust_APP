                    ...
                    <div class="kt-portlet__body">
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="receipt_date" id="receipt_date" placeholder="Select Date" ng-model="receiptDate">
                                    ...
                                    <div class="col-md-4" ng-if="showForYearSponsor">
                                        ...
                                        <select class="form-control for_year" name="for_year" id="for_year" ng-selected="{{courseTypeData.id == courseTypeHidden}}" ng-model="SponsorCommitId" ng-change="loadRemarks(SponsorCommitId)">



                                            <option value="">Select Year</option>

                                            <option  ng-repeat="(key, forYearOption_data) in forYearOption" value="{{forYearOption_data.id}}" data-for-year="{{forYearOption_data.for_year}}" ng-selected="{{forYearOption_data.for_year == forYearHidden}}">{{forYearOption_data.for_year| convertDate}}-{{forYearOption_data.remarks}}</option>
                                    ...
                                    <div class="col-md-4" ng-if="showForYearScholarship">
                                        ...
                                        <select class="form-control" name="for_year" id="for_year_scholar"  ng-model="ScholarYear" ng-change="loadPaidAmount(ScholarYear)">
                                            <option value="">Select Year</option>
                                            <option  ng-repeat="(key, forYearOption_data) in forYearOptionS" value="{{forYearOption_data}}" data-for-year="{{forYearOption_data}}" ng-selected="{{forYearOption_data == forYearHidden}}">{{forYearOption_data| convertDate}}</option>
                                        </select>
                                    ...
                                    <div class="col-md-4" ng-if="showForYear">
                                        ...
                                        <input type="text" class="form-control for_year" name="for_year" id="for_year_date" ng-model="forYear">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="kt-radio-inline">
                                            ...
                                            <label class="kt-radio">
                                                ...
                                                <input type="radio" name="cancelled" value="1" ng-click="showCancelled('true')" ng-model="cancelled"> Yes
                                            ...
                                            <label class="kt-radio">
                                                ...
                                                <input type="radio" name="cancelled" value="0" ng-click="showCancelled('false')" ng-model="cancelled"> No
                        ...
                        <div class="form-group row" ng-if="toggleCancelledDiv">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" aria-describedby="emailHelp" name="cancelled_reason" id="cancelled_reason" placeholder="Enter Cancelled Reason" ng-model="cancelledReason">
                            ...
                            <div class="col-md-3">
                                ...
                                <textarea class="form-control" aria-describedby="emailHelp" name="remark" id="remark" placeholder="Enter Remark" ng-model="cencelledRemark"></textarea>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-12 pt-12">
                                ...
                                <div class="text-center">
                                    ...
                                    <button type="button" id="submit_edit_receipts_form" class="btn btn-brand" disabled>Save</button>
...
<script type="text/javascript">
    ...
    edit_receipt_app.controller('edit_receipt_controller', ['$scope', '$http', '$compile', '$location', '$window', '$timeout', function ($scope, $http, $compile, $location, $window, $timeout) {
                ...
                if (receipt_id) {
                    ...
                    $http.get(base_url + 'receipts/getReceiptData?id=' + receipt_id)
                            ...
                            .success(function (response) {
                                ...
                                var receipt_type = response.receipts[0]['receipt_type_id'];
                                ...
                                $('#receipt_type_id').val(response.receipts[0]['receipt_type_id']);
                                ...
                                if (response.receipts[0]['receipt_type_id'] == "1") {
                                    ...
                                    $('#name_value').val(response.users[0]['id']);
                                ...
                                if (response.receipts[0]['receipt_type_id'] == "2" || response.receipts[0]['receipt_type_id'] == "5") {
                                    ...
                                    $('#name_value').val(response.sponsor_details[0]['id']);
                                }
                                ...
                                if (response.receipts[0]['receipt_type_id'] == "3" || response.receipts[0]['receipt_type_id'] == "4") {
                                    ...
                                    $('#name_value').val(response.scholarship_details[0]['id']);
                                }	
                                
                                if (response.receipts[0]['receipt_type_id'] == "3" ){	
                                    $scope.showApplicationNo = true;
                                    $('#approved_amount').val(response.scholarship_details[0]['approved_amount']);	
                                    $scope.application_number = response.scholarship_details[0]['scholarship_id'];
                                    $('#paidamount').val(response.receipt_pay['paidamount']);
                                    $scope.ScholarYear = $scope.convertToFormDate(response.receipts[0]['for_year']);
                                }
                                $scope.loadProfileImg();
                                ...
                                if (response.receipts[0]['receipt_type_id'] == "2") {
                                    ...
                                    $scope.sponsorRemarks = response.receipts[0]['remarks'];
                                ...
                                if (response.receipts[0]['cancelled'] == "1") {
                                    ...
                                    $scope.cencelledRemark = (response.receipts[0]['remarks'] && response.receipts[0]['remarks']  != 'undefined') ? response.receipts[0]['remarks']  : '';
                                ...
                                setTimeout(function () {
                                    ...
                                    $('#submit_edit_receipts_form').attr("disabled", false);

                                }, 100);

                                $scope.sponsorRemarks = (response.receipts[0]['remarks'] && response.receipts[0]['remarks']  != 'undefined') ? response.receipts[0]['remarks']  : '';
                                
                        
                                if (response.receipts[0]['receipt_type_id'] == "1" || response.receipts[0]['receipt_type_id'] == "4" || response.receipts[0]['receipt_type_id'] == "5") {
                                    $scope.forYear = $scope.convertToFormDate(response.receipts[0]['for_year']);
                                }
                                if (response.receipts[0]['receipt_type_id'] == "2"){
                                    $scope.SponsorCommitId = $scope.convertToFormDate(response.receipts[0]['for_year']);
                                    $http.get(base_url + 'receipts/getRemarks?id=' + response.commitment_id).success(function (response) {
                                ...
                                var url = $location.absUrl();
                                var receipt_id = url.substring(url.lastIndexOf('/') + 1);	
                                $http.get(base_url + 'receipts/getScholarPaid?year=' + response.receipts[0]['for_year']+'&name=' + $('#selected_name').val()+'&receipt_type_id=' + response.receipts[0]['receipt_type_id']+'&receipt_id=' + receipt_id).success(function (response) {	
                                    if(response.receipts[0]['for_year'] != undefined)
            ...
            $scope.loadPaidAmount = function (ScholarYear) {
                var url = $location.absUrl();
                var receipt_id = url.substring(url.lastIndexOf('/') + 1);	
                $http.get(base_url + 'receipts/getScholarPaid?year=' + ScholarYear+'&name=' + $('#selected_name').val()+'&receipt_type_id=' + $('#receipt_type_id').val()+'&receipt_id=' + receipt_id).success(function (response) {	
                    if(ScholarYear != undefined)
                        $("#paidamount").val((response.paidamount !=null) ? response.paidamount : '0');
                });
            }
            ...
            $scope.loadProfileImg = function () {
                var receipt_type = $scope.receiptTypeVal;
                var name = ($scope.nameVal == undefined) ? $('#name_value').val() : $scope.nameVal;
                var url = $location.absUrl();
                var receipt_id = url.substring(url.lastIndexOf('/') + 1);
                $http.get(base_url + 'receipts/getProfileImg?receipt_type_id=' + receipt_type + "&name_id=" + name+ "&receipt_id=" + receipt_id).success(function (response) {
    ...
    $('#submit_edit_receipts_form').click(function (e) {
        ...
        var remark = $("#sponsor_remarks").val();
        ...
        if(receipt_type_id == 1){
            ...
            $.ajax({
                ...
                success: function (data) {  
                    if (data) {	
                        $(".error-span").html("");	
                        $('#submit_edit_receipts_form').removeClass('kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light').attr('disabled', false);    	
                        Swal.fire(	
                            'Warning!',	
            ...
            if(receipt_type_id == 2 || receipt_type_id == 3 || receipt_type_id == 4){
                ...
                if(paidamount == 0){
                    ...
                    $('#submit_edit_receipts_form').removeClass('kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light').attr('disabled', false);    	
                        Swal.fire(	
                            'Warning!',	
                            'Cannot Make Rceipt .. Already Made Payment!',	
                            'error'	
                            );	
                            return false;	
                }
    ...
    function edit_receipt(formData) {

        $.ajax({

            method: "POST",

            url: base_url + "receipts/edit_receipt_details",
